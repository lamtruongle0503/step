...
class Admin::HotelOperations::OptionOperations::Update < ApplicationOperation
  attr_reader :hotel_option

  def initialize(actor, params)
    super
    @hotel_option = Hotel::Option.find(params[:id])
  end
  ...
  def update_hotel_option
    HotelContracts::OptionContracts::Update.new(hotel_option_params).valid!
    hotel_option.update!(hotel_option_params)
  end
