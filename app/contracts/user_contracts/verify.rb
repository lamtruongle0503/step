...
class UserContracts::Verify < ApplicationContract
  ...
  def invalid_token!
    ...
    errors.add :verify_code, I18n.t('verify.invalid_verify_code') if user_verify_code != verify_code
  end

  def verify_code_expired!
    errors.add :verify_code, I18n.t('verify.verify_code_expired') if code_expired?
  end
