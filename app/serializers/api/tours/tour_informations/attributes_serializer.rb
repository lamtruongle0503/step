...
class Api::Tours::TourInformations::AttributesSerializer < ApplicationSerializer
  attributes :id, :adult_dayoff_amount,
             ...
             :min_price
  def max_price
    object.max_price.round - object.tour.discount
  end

  def min_price
    object.min_price.round - object.tour.discount
  end
end
