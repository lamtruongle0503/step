...
class Api::Tours::Stays::Reservations::ShowSerializer < ApplicationSerializer
  attributes :id, :name, :code, :title, :tax, :start_date, :stayed_nights, :hostel_name,
             :tour_guide, :staff_name, :date_of_cancellation_fee, :start_date, :end_date,
             :point_receive_rate, :point_bonus_rate, :other_fee, :bus_seats, :coupons

  has_many :tour_options, serializer: Api::Tours::Options::AttributesSerializer
  ...
  has_many :payments, serializer: Api::Tours::Payments::AttributesSerializer
