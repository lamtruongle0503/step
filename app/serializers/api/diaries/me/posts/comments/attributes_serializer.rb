...
class Api::Diaries::Me::Posts::Comments::AttributesSerializer < ApplicationSerializer
  attributes :id, :contents, :comment_type, :is_follow, :is_blocked, :is_blocked_by_owner,
  ...
  def children
    object.children.last(1).map do |obj|
      Api::Diaries::Me::Posts::Comments::ChildrenSerializer.new(obj, @actor).as_json
    end
  end
end
